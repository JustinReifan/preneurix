...
<div id="content-wrapper" class="d-flex flex-column min-vh-100">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow-lg d-md-none"
            style="background-color:#14171f;">

            <a class="d-md-none d-flex align-items-center mx-3 text-decoration-none"
                href="<?= base_url('course/details/') . $course['id']; ?>">
